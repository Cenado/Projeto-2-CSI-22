# CSI 22 
**Projeto P2 e Exame - Professora Karla D. Fook**

**Refatoração de Jogo** : Aplicação de conceitos de *Programação Orientada a Objeto*, e *Padrão de Projeto*.
...
|------|--------|
| Arthur | |
| Danilo Carlos | danilo.silva.9039@ga.ita.br |
